                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <select name="type" class="form-control" required x-on:change="userType = $event.target.value">
                                    <option value="{{ $model::TYPE_USER }}" {{ $user->type === $model::TYPE_USER ? 'selected' : '' }}>@lang('Visitor')</option>
                                    {{-- <option value="{{ $model::TYPE_CUSTOMER }}" {{ $user->type === $model::TYPE_CUSTOMER ? 'selected' : '' }}>@lang('Customer')</option> --}}
