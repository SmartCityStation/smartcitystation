                ...
                @else
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <!-- Dashboard visitor-->
                            <x-utils.link :href="url('index/measure')" :active="activeClass(Route::is('frontend.index.measure'))" :text="__('Home')" class="dropdown-item" />

                            <!--Dashboard customer-->
                            {{-- <x-utils.link :href="route('frontend.measures.measureIndex')" 
                            :active="activeClass(Route::is('frontend.measures.measureIndex'))" 
                            :text="__('Dashboard')" class="dropdown-item" /> --}}

                            @if ($user->type == 'customer')
                                <x-utils.link :href="route('frontend.customer.measure')" :active="activeClass(Route::is('frontend.customer.measure'))" :text="__('Analytics')"
                                    class="dropdown-item" />
                            @endif
